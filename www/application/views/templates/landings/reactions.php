...
<div class="reactions">
    ...
    <div class="reactions__footer">
        <div class="reactions__footer-logo">
            <div class="reactions__footer-icon">
                <? include(DOCROOT . "public/app/landings/reactions/img/product_hunt_logo_orange.svg") ?>
            </div>
            <h2 class="reactions__footer-title">Oh, hi Mark!</h2>
        </div>
        <p class="reactions__footer-description">We are CodeX, and we build products <br> for developers and makers. Follow us.</p>
