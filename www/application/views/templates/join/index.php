    ...
    <? if (!empty($success)): ?>
        <div class="join-page__success">
            <div class="join-page__success-inner">
                <h2>Спасибо!</h2>
                <p>Мы получили вашу заявку. Прием заявок продлится до 22 сентября. После окончания приема заявок мы с вам свяжемся. А пока подписывайтесь на нашу <a href="https://vk.com/codex_team">группу ВКонтакте</a> и следите за новостями. </p>
            </div>
        </div>
    <? endif ?>
