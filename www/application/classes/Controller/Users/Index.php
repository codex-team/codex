...
class Controller_Users_Index extends Controller_Base_preDispatch
{
    ...
    {
        $user_feed_items  = Model_Article::getArticlesByUserId($user_id, false, ['user_articles:'. $user_id]);
        $coauthor_feed_items = Model_Coauthors::getArticlesByCoauthorId($user_id,false,['user_articles:' . $user_id]);
