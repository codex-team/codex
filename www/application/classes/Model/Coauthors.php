...
class Model_Coauthors extends Model
{
     ...
     */
    public static function getArticlesByCoauthorId($user_id, $clearCache = false, $tags = [])
    {
        ...
        if ($coauthors_rows) {
            $coauthor_articles = Model_Article::getSome(array_keys($coauthors_rows), $clearCache, true, $tags);
        }
