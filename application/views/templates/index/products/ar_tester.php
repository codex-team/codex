<div class="product-card product-card--ar-tester">
    ...
    <div class="product-card__caption">
        ...
        <div class="product-card__actions">
            <div class="product-card__watch-button" name="js-show-player">
                Watch Video
            </div>
        ...
        <div class="product-card__disclaimer">
    ...
    <div class="product-card__right">
        <img class="product-card__screen" src="/public/app/img/products/arkit.png" alt="AR Teser by CodeX Team">
        <div class="product-card__download product-card__download--appstore" href="">
            <? include(DOCROOT . 'public/app/img/products/appstore.svg'); ?>
            Available on the
            <b>AppStore</b>
        </div>
    </div>
    <a class="product-card__repo" href="https://github.com/codex-team/AR-tester">
        github.com/codex-team/AR-tester
    </a>
</div>
