<? if (!empty($success)): ?>
    <div class="success_alert">
        <h2>Спасибо!</h2>
        <p>Мы получили вашу заявку. Набор продлится приблизительно до 9 октября, после чего мы свяжемся с вами. А пока подписывайтесь на нашу <a href="https://vk.com/codex_team">группу ВКонтакте</a> и следите за новостями. </p>
    </div>
<? endif ?>
