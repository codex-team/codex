...
<body class="black_land">
    <div class="wrapper ">
        <div class="main">
            <ul class="menu">
                ...
                <li><a href="/articles/edit/new">Добавить статью</a></li>
            </ul>
    ...
    <div class="footer">
        <div class="light_grey_block">
            <div class="inside">
                <a href="#top" class="go_top">Go top</a>
            </div>
        </div>
    </div>

    <script src="/public/js/main.js?v=<?= filemtime("public/js/main.js") ?>"></script>
    <script src="/public/js/articles.js?v=<?= filemtime("public/js/articles.js") ?>"></script>
    <? /*
